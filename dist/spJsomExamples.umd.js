/*! spJsomFluent "0.1.30" - https://github.com/TjWheeler/spJsomFluent */
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/spJsomExamples-typescript.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./examples/spJsomExamples-typescript.ts":
/*!***********************************************!*\
  !*** ./examples/spJsomExamples-typescript.ts ***!
  \***********************************************/
/*! no exports provided */
...
/* harmony import */ var _src_fluent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/fluent */ "./src/fluent.ts");
...
var examples = {
    ...
    deleteListItem: function () {
        ...
        new _src_fluent__WEBPACK_IMPORTED_MODULE_0__["Fluent"]()
            .withContext(context)
    ...
    provisionWebWithProgress: function () {
        ...
        new _src_fluent__WEBPACK_IMPORTED_MODULE_0__["Fluent"]()
            .withContext(context)
            .onActionExecuting(function (actionName, current, total) {
            var progress = Math.ceil(100 * current / total);
            console.log("Executing: " + actionName + ", we are " + progress + "% through.");
        })
            .onActionExecuted(function (actionName, success, results) {
    ...
    customActionCommands: function () {
        var context = SP.ClientContext.get_current();
        new _src_fluent__WEBPACK_IMPORTED_MODULE_0__["Fluent"]()
            .withContext(context)
            .chainAction("myCustomCommand", function () {
            var deferred = $.Deferred();
            context.get_web().set_title("My new title");
            context.get_web().update();
            _src_fluent__WEBPACK_IMPORTED_MODULE_0__["Fluent"].executeQuery(context)
                .fail(function (sender, args) {
    ...
    customActionCommandsChain: function () {
        var context = SP.ClientContext.get_current();
        var customAction = new _src_fluent__WEBPACK_IMPORTED_MODULE_0__["ActionCommand"]();
    ...
    conditionalExample: function () {
        var context = SP.ClientContext.get_current();
        var fluent = new _src_fluent__WEBPACK_IMPORTED_MODULE_0__["Fluent"]();
        fluent
            .withContext(context)
            .listItem.deleteById(context.get_web(), "MyList", 7);
        if (false) {}
...
var File = /** @class */ (function () {
    ...
    */
    File.prototype.getListItem = function (web, serverRelativeUrl) {
        var _this = this;
        return this.fluent.chainAction(this._helperName + ".getListItem", function () {
            return _this.listHelper.getFileListItem(web, serverRelativeUrl);
        });
    };
    /**
    * Check in a file
    ...
    */
    File.prototype.checkOut = function (web, serverRelativeUrl) {
        var _this = this;
        return this.fluent.chainAction(this._helperName + ".checkOutFile", function () {
            return _this.listHelper.checkOutFile(web, serverRelativeUrl);
        });
    };
    /**
    ...
    */
    File.prototype.uploadFile = function (web, listName, file, filename) {
        var _this = this;
        return this.fluent.chainAction(this._helperName + ".uploadFile", function () {
            return _this.listHelper.uploadFile(web, listName, file, filename);
        });
    };
    return File;
}());
...
var Fluent = /** @class */ (function () {
    ...
    Fluent.prototype.update = function (predicate) {
        var _this = this;
        ...
        command.action = function () {
            ...
            if (command) {
                predicate.apply(void 0, command.result);
                _common__WEBPACK_IMPORTED_MODULE_8__["common"].executeQuery(_this.context)
                ...
                _this.failChain(_this, "No action to process for update");
            }
            return deferred.promise();
        };
...
/***/ "./src/helper/SPRestFileHelper.ts":
/*!****************************************!*\
  !*** ./src/helper/SPRestFileHelper.ts ***!
  \****************************************/
/*! exports provided: SPRestFileUploader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SPRestFileUploader", function() { return SPRestFileUploader; });
// This has moved to /src/Common/js
var SPRestFileUploader = /** @class */ (function () {
    function SPRestFileUploader() {
    }
    SPRestFileUploader.prototype.uploadFileAsArrayBuffer = function (file, webUrl, listname, filename, progressCallback) {
    ...
    SPRestFileUploader.prototype.updateListItem = function (webUrl, serverRelativeUrl, properties, etag) {
        if (etag === void 0) { etag = "*"; }
        if (etag) {
...
/* harmony import */ var _SPRestFileHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SPRestFileHelper */ "./src/helper/SPRestFileHelper.ts");
...
var ListHelper = /** @class */ (function () {
    ...
    ListHelper.prototype.uploadFile = function (web, listname, file, filename) {
        var _this = this;
        var deferred = $.Deferred();
        if (!filename) {
            filename = file.name;
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["common"].executeQuery(this.context)
            .fail(function (sender, args) { deferred.reject(sender, args); })
            .done(function () {
            var upload = new _SPRestFileHelper__WEBPACK_IMPORTED_MODULE_1__["SPRestFileUploader"]();
    ...
    ListHelper.prototype.checkOutFile = function (web, serverRelativeUrl) {
        var deferred = $.Deferred();
        var file = web.getFileByServerRelativeUrl(serverRelativeUrl);
        this.context.load(file);
        file.checkOut();
    ...
    ListHelper.prototype.getFileListItem = function (web, serverRelativeUrl, viewFields) {
        if (viewFields === void 0) { viewFields = null; }
        var file = web.getFileByServerRelativeUrl(serverRelativeUrl);
...
var PageHelper = /** @class */ (function () {
    ...
    PageHelper.prototype.createPublishingPage = function (web, name, layoutUrl, title) {
        var _this = this;
        var deferred = $.Deferred();
        if (!title) {
...
var WebHelper = /** @class */ (function () {
    ...
    WebHelper.prototype.setTitle = function (web, title) {
        var deferred = $.Deferred();
        this.context.load(web);
        web.set_title(title);
        web.update();
    ...
    WebHelper.prototype.setLogoUrl = function (web, url) {
        var deferred = $.Deferred();
        this.context.load(web);
        web.set_siteLogoUrl(url); //TS definition missing here.
        web.update();
        _common__WEBPACK_IMPORTED_MODULE_0__["common"].executeQuery(this.context)
            .fail(function (sender, args) { deferred.reject(sender, args); })
            .done(function () {
    ...
    WebHelper.prototype.activateFeature = function (web, featureId, force) {
        var deferred = $.Deferred();
        this.context.load(web);
...
var ListItem = /** @class */ (function () {
    ...
    */
    ListItem.prototype.getFileListItem = function (web, serverRelativeUrl, viewFields) {
        var _this = this;
        if (viewFields === void 0) { viewFields = null; }
        return this.fluent.chainAction(this._helperName + ".getFileListItem", function () {
            return _this.listHelper.getFileListItem(web, serverRelativeUrl, viewFields);
        });
    };
    /**
    * Delete List Item
...
var PublishingPage = /** @class */ (function () {
    ...
    */
    PublishingPage.prototype.create = function (web, name, layoutUrl, title) {
        var _this = this;
        this.fluent.registerDependency(_fluent__WEBPACK_IMPORTED_MODULE_0__["Dependency"].Publishing);
        return this.fluent.chainAction(this._helperName + ".create", function () {
            return _this.pageHelper.createPublishingPage(web, name, layoutUrl, title);
        });
    };
    /**
    * Gets a page layout.
...
var Web = /** @class */ (function () {
    ...
    /**
      ...
      */
    Web.prototype.setTitle = function (web, title) {
        var _this = this;
        return this._fluent.chainAction(this._helperName + ".setTitle", function () {
            return _this.webHelper.setTitle(web, title);
        });
    };
    /**
      * Set site logo url
      ...
      */
    Web.prototype.setLogoUrl = function (web, url) {
        var _this = this;
        return this._fluent.chainAction(this._helperName + ".setLogoUrl", function () {
            return _this.webHelper.setLogoUrl(web, url);
        });
    };
    /**
      * Activate feature
      ...
      */
    Web.prototype.activateFeature = function (web, featureId, force) {
        var _this = this;
        if (force === void 0) { force = true; }
        return this._fluent.chainAction(this._helperName + ".activateFeature", function () {
            return _this.webHelper.activateFeature(web, featureId, force);
        });
    };
    return Web;
}());
