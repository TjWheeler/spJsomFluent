...
var File = /** @class */ (function () {
    function File(fluent) {
        ...
        this.fluent = fluent;
        this.listHelper = new _helper_listHelper__WEBPACK_IMPORTED_MODULE_0__["default"](fluent.context);
    }
    /**
...
var Fluent = /** @class */ (function () {
    ...
    Object.defineProperty(Fluent.prototype, "permission", {
        get: function () {
            return new _permission__WEBPACK_IMPORTED_MODULE_1__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "list", {
        get: function () {
            return new _list__WEBPACK_IMPORTED_MODULE_2__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "listItem", {
        get: function () {
            return new _listitem__WEBPACK_IMPORTED_MODULE_3__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "file", {
        get: function () {
            return new _file__WEBPACK_IMPORTED_MODULE_4__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "publishingPage", {
        get: function () {
            return new _publishingpage__WEBPACK_IMPORTED_MODULE_7__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "web", {
        get: function () {
            return new _web__WEBPACK_IMPORTED_MODULE_0__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "user", {
        get: function () {
            return new _user__WEBPACK_IMPORTED_MODULE_5__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fluent.prototype, "navigation", {
        get: function () {
            return new _navigation__WEBPACK_IMPORTED_MODULE_6__["default"](this);
        },
        enumerable: true,
        configurable: true
    });
    Fluent.prototype.execute = function () {
        ...
        if (this.settings.enableDependencyTimeout) {
            var expiry = setTimeout(function () {
                _common__WEBPACK_IMPORTED_MODULE_8__["default"].reject(_this.resultPromise, "Timeout waiting for dependencies to load");
    ...
    Fluent.executeQuery = function (context) {
        return _common__WEBPACK_IMPORTED_MODULE_8__["default"].executeQuery(context);
    };
...
var ListHelper = /** @class */ (function () {
    ...
    ListHelper.prototype.createList = function (web, listName, templateId) {
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(this.context)
    ...
    ListHelper.prototype.createListItemWithContentTypeName = function (web, listName, contentTypeName, properties) {
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(clientContext)
            .fail(function (sender, args) { deferred.reject(sender, args); })
            .done(function () {
    ...
    ListHelper.prototype.addContentTypeListAssociation = function (web, listName, contentTypeName) {
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(this.context)
            ...
            if (!contentType) {
                _common__WEBPACK_IMPORTED_MODULE_0__["default"].reject(deferred, "Content Type " + contentTypeName + " not found");
                return;
            }
            ...
            if (listCt) {
                ...
                list.update();
                _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(_this.context)
                    .fail(function (sender, args) { deferred.reject(sender, args); })
                    .done(function () {
    ...
    ListHelper.prototype.setDefaultValueOnList = function (web, listName, fieldInternalName, defaultValue) {
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(this.context)
            ...
            if (field) {
                ...
                _common__WEBPACK_IMPORTED_MODULE_0__["default"].reject(deferred, "Field " + fieldInternalName + " not found");
            }
        });
        return deferred.promise();
    };
...
/* harmony default export */ __webpack_exports__["default"] = (ListHelper);
        ...
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(this.context)
            ...
            switch (navigationType) {
                ...
                case _fluent__WEBPACK_IMPORTED_MODULE_1__["NavigationType"].Managed:
                    _common__WEBPACK_IMPORTED_MODULE_0__["default"].reject(deferred, "Not implemented");
                    break;
                ...
                case _fluent__WEBPACK_IMPORTED_MODULE_1__["NavigationType"].StructuralChildrenOnly:
                    ...
                    break;
                default:
                    _common__WEBPACK_IMPORTED_MODULE_0__["default"].reject(deferred, "Unknown Navigation Type");
            }
            nav.update(null);
            _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(_this.context)
                .fail(function (sender, args) { deferred.reject(sender, args); })
...
/* harmony default export */ __webpack_exports__["default"] = (NavigationHelper);
...
/* harmony default export */ __webpack_exports__["default"] = (PageHelper);
...
/* harmony default export */ __webpack_exports__["default"] = (PermissionHelper);
...
/* harmony default export */ __webpack_exports__["default"] = (UserHelper);
...
var WebHelper = /** @class */ (function () {
    ...
    WebHelper.prototype.getAllWebs = function (context, web, output) {
        ...
        context.load(webs);
        _common__WEBPACK_IMPORTED_MODULE_0__["default"].executeQuery(context)
            .fail(function (sender, args) {
            deferred.reject(sender, args);
        })
            .done(function () {
...
/* harmony default export */ __webpack_exports__["default"] = (WebHelper);
...
var ListItem = /** @class */ (function () {
    ...
    */
    ListItem.prototype.getAll = function (web, listName, viewXml) {
        var _this = this;
        return this.fluent.chainAction(this._helperName + ".query", function () {
...
var Navigation = /** @class */ (function () {
    function Navigation(fluent) {
        ...
        this.fluent = fluent;
        this.navigationHelper = new _helper_navigationHelper__WEBPACK_IMPORTED_MODULE_0__["default"](fluent.context);
    }
    /**
...
var Permission = /** @class */ (function () {
    function Permission(fluent) {
        ...
        this._fluent = fluent;
        this.permissionHelper = new _helper_permissionHelper__WEBPACK_IMPORTED_MODULE_0__["default"](fluent.context);
    }
    /**
...
var PublishingPage = /** @class */ (function () {
    function PublishingPage(fluent) {
        ...
        this.fluent = fluent;
        this.pageHelper = new _helper_pageHelper__WEBPACK_IMPORTED_MODULE_1__["default"](fluent.context);
    }
    /**
...
/* harmony default export */ __webpack_exports__["default"] = (PublishingPage);
...
var User = /** @class */ (function () {
    function User(fluent) {
        ...
        this._fluent = fluent;
        this.userHelper = new _helper_userHelper__WEBPACK_IMPORTED_MODULE_0__["default"](fluent.context);
    }
    /**
...
var Web = /** @class */ (function () {
    function Web(fluent) {
        ...
        this.webHelper = null;
        this._fluent = fluent;
        this.webHelper = new _helper_webHelper__WEBPACK_IMPORTED_MODULE_0__["default"](fluent.context);
    }
    /**
